...
<div class="wrap">
	...
	<form method="post" id="submission-details-form" enctype="multipart/form-data">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<select id="time_zone" name="time_zone" class="regular-text">
						...
						$time_zones       = Show_Submissions_Constants::get_time_zones();
			...
			<tr>
				...
				<td>
					...
					<?php if ( ! empty( $submission->status ) && 'Approved' === $submission->status ) : ?>
		...
		<div class="submit-buttons">
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=show-submissions' ) ); ?>" class="button">Back to List</a>
